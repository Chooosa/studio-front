export const ru = {
    ...
    your_goals_idea: 'У вас есть идея для мобильного приложения или сайта и вы не знаете с чего начать? ',
    your_goals_site: 'У вас есть сайт и для привлечения новых пользователей вы хотите мобильное приложение?',
    your_goals_product: 'У вас уже есть готовый продукт, но пользователи неохотно пользуются им?',
