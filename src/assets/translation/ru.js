export const ru = {
    ...
    your_goals_site: 'У вас уже есть сайт и для привлечения новых пользователей вам необходимо мобильное приложение',
    your_goals_product: 'Вам необходимо расширить уже существующий функционал',
    ...
    interview: 'Интервью',
    interview_desc_intro: `В первую очередь нам важно получить полный обьем информации о проекте, чтобы в дальнейшем:`,
    ...
    interview_desc_outro: `На этом этапе вы получите представление о ходе работы и стоимости реализации проекта.`,
